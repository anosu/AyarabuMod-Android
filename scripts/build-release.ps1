...
$modProject = Join-Path $repoRoot "AyarabuMod/AyarabuMod.csproj"
...
$utilityAssembly = Join-Path $repoRoot "AyarabuMod/bin/$Configuration/Utility.dll"
...
$modAssembly = Join-Path $repoRoot "AyarabuMod/bin/$Configuration/AyarabuMod.dll"
...
$archivePath = Join-Path $outputDirectory "AyarabuMod-Android.zip"
...
$inputs = [ordered]@{
    "Mods/AyarabuMod/AyarabuMod.dll" = $modAssembly
    "Mods/AyarabuMod/Utility.dll" = $utilityAssembly
}

New-Item -ItemType Directory -Path $outputDirectory -Force | Out-Null
$unexpectedFiles = @(
    Get-ChildItem -LiteralPath $outputDirectory -Force |
        Where-Object { $_.Name -notin @("AyarabuMod-Android.zip", "AyarabuMod-Android.zip.tmp", "SHA256SUMS.txt") }
)
...
[System.IO.File]::WriteAllText(
    $sumsPath,
    "$archiveHash  AyarabuMod-Android.zip`n",
